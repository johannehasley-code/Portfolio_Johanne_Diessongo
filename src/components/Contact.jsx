    ...
    <>
      ...
      <section className="contact" id="contact" ref={sectionRef}>
        ...
        <div className="contact-inner">
          ...
          <p className="contact-sub reveal">Ouverte aux opportunités de stage, collaborations en FinTech, finance de marchés et projets d'innovation. N'hésitez pas à me contacter !</p>
      ...
      <div className="footer-bar">
        © 2026 Johanne Hasley Diessongo · Ingénieure · FinTech · Finance de Marchés
      </div>
    </>
  );
}
